...
export const Header = () => {
  ...
  return (
    <header className="header_backgroud pb-5 pt-2">
      <div className="screen-max-width max-md:w-full">
        <div className="flex justify-end gap-5">
          ...
          <div className="flex items-center py-1 hover:text-gray-300 cursor-pointer">
            <div className="w-6 h-6 mr-2 flex-shrink-0">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1DeyZNqRdLF9WiyJOo7YQW5HxbSp3F6tNQQ&s"
                alt=""
        ...
        <div className="mt-4 flex items-center justify-between">
          <Link to="/" className="mr-10 max-md:mr-3">
            <svg
              viewBox="0 0 192 65"
              className="max-w-[162px] w-full fill-white"
            >
              <g fillRule="evenodd">
          ...
          >
            <input
              type="text"
              className="p-3 text-sm w-[600px] outline-none max-md:w-full max-md:p-2"
            ...
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="size-6 text-white w-[50px] rounded-sm max-md:w-[50px]"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
